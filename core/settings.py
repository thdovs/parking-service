...
SECRET_KEY = 'django-insecure-v5!ywyu+(st-_v$40kzcthz65f##i45i5fphi$t#6680zshlwk'
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "images/parking_logo.svg",
    ...
    # for the full list of 5.13.0 free icon classes
     "icons": {
         ...
         "parking.ParkingRecord": "fa-solid fa-right-left"
    },
